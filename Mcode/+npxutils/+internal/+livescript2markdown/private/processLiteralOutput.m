...
str(idx_lstlisting) = newline + "```matlab" + newline ...
  + extractBetween(str(idx_lstlisting), "\begin{lstlisting}", "\end{lstlisting}") ...
  + "```" + newline;
str(idx_verbatim) = newline + "```matlab" + newline ...
  + extractBetween(str(idx_verbatim), "\begin{verbatim}", "\end{verbatim}") ...
  + "```" + newline;
str(idx_matlabcode) = newline + "```matlab" + newline ...
  + extractBetween(str(idx_matlabcode), "\begin{matlabcode}", "\end{matlabcode}") ...
  + "```" + newline;
str(idx_matlaboutput) = newline + "```text" + newline ...
  + extractBetween(str(idx_matlaboutput), "\begin{matlaboutput}", "\end{matlaboutput}") ...
  + "```" + newline;
